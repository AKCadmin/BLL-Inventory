                                        ...
                                        <form action="{{ route('reset-password.submit') }}" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $userdata[0]['name'] }}" readonly>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="password"
                                                    ...
                                                    id="userpassword" name="new_password" placeholder="Enter password"
                                                    required>
                                                @error('password')
                                            ...
                                            <div class="mb-3">
                                                <label for="userpassword_confirmation" class="form-label">Re-enter new password</label>
                                                <input type="password"
                                                    class="form-control @error('password_confirmation') is-invalid @enderror"
                                                    id="userpassword_confirmation" name="new_password_confirmation" placeholder="Confirm password"
                                                    required>
                                            </div>
