...
<body>
    ...
    <p> <a href="{{ route('logout') }}"
        class="fw-medium text-primary"> Logout </a> </p>
                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <button type="button" class="btn btn-sm px-3
                            font-size-16 header-item waves-effect"
                        ...
                        <div class="dropdown dropdown-mega d-none d-lg-block
                            ...
                            <button type="button" class="btn header-item
                                waves-effect" data-bs-toggle="dropdown"
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <ul class="list-unstyled
                                                    ...
                                                    <li>
                                                        <a
                                                            href="javascript:void(0);"
                                                            key="t-range-slider">Range
                                                            Slider</a>
                                                    </li>
                                                    <li>
                                                        <a
                                                            href="javascript:void(0);"
                                                            key="t-sweet-alert">Sweet
                                                            Alert</a>
                                                    </li>
                                                    <li>
                                                        <a
                                                    ...
                                                    <li>
                                                        <a
                                                            href="javascript:void(0);"
                                                            key="t-tables">Tables</a>
                                                    </li>
                                                    <li>
                                                        <a
                                                            href="javascript:void(0);"
                                                            key="t-charts">Charts</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <ul class="list-unstyled
                                                    ...
                                                    <li>
                                                        <a
                                                            href="javascript:void(0);"
                                                            key="t-light-sidebar">Light
                                                            Sidebar</a>
                                                    </li>
                                                    <li>
                                                        <a
                                                            href="javascript:void(0);"
                                                            key="t-compact-sidebar">Compact
                                                            Sidebar</a>
                                                    </li>
                                                    <li>
                                                        <a
                                                            href="javascript:void(0);"
                                                            key="t-horizontal">Horizontal
                                                            layout</a>
                                                    </li>
                                                    <li>
                                                        <a
                    ...
                    <div class="d-flex">
                                    ...
                                    <a href="" class="text-reset
                                        ...
                                        <div class="d-flex">
                                            <img
                                                ...
                                                avatar-xs" alt="user-pic">
                                            <div class="flex-grow-1">
                                                <h6 class="mt-0 mb-1">Salena
                                                    Layfield</h6>
                                                <div class="font-size-12
                                                    text-muted">
                                                    <p class="mb-1"
                                                        key="t-occidental">As a
                                                        skeptical Cambridge
                                                        friend of
                                                        mine occidental.</p>
                                                    <p class="mb-0"><i
                                ...
                                <div class="p-2 border-top d-grid">
                                    <a class="btn btn-sm btn-link font-size-14
                                        ...
                                        <i class="mdi mdi-arrow-right-circle
                                            me-1"></i> <span key="t-view-more">View
                                            More..</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item
                                waves-effect" id="page-header-user-dropdown"
                                data-bs-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item text-danger" href="{{ route('logout.get') }}"><i class="bx bx-power-off font-size-16 align-middle me-1 text-danger"></i> <span key="t-logout">Logout</span></a>
                            </div>
                        </div>

                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item
                                noti-icon right-bar-toggle waves-effect">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="true">
                                    <li>
                                        <a href="javascript: void(0);"
                                            class="has-arrow" key="t-vertical">Vertical</a>
                                        <ul class="sub-menu"
                                            aria-expanded="true">
                                            <li><a target="_blank"
                                            ...
                                            <li><a target="_blank"
                                                    ...
                                                    key="t-icon-sidebar">Icon
                                                    Sidebar</a></li>
                                            <li><a target="_blank"
                                                    href="layouts-boxed.html"
                                                    key="t-boxed-width">Boxed
                                                    Width</a></li>
                                            <li><a target="_blank"
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu"
                                            ...
                                            <li><a target="_blank"
                                                    ...
                                                    key="t-horizontal">Horizontal</a></li>
                                            <li><a target="_blank"
                                                    href="layouts-hori-topbar-light.html"
                                                    key="t-topbar-light">Topbar
                                                    light</a></li>
                                            <li><a target="_blank"
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a target="_blank"
                                            ...
                                            key="t-recover-password">Recover
                                            Password</a></li>
                                    <li><a target="_blank"
                                            href="auth-recoverpw-2.html"
                                            key="t-recover-password-2">Recover
                                            Password 2</a></li>
                                    <li><a target="_blank"
                                            href="auth-lock-screen.html"
                                            key="t-lock-screen">Lock Screen</a></li>
                                    <li><a target="_blank"
                                            href="auth-lock-screen-2.html"
                                            key="t-lock-screen-2">Lock Screen 2</a></li>
                                    <li><a target="_blank"
                                            href="auth-confirm-mail.html"
                                            key="t-confirm-mail">Confirm Email</a></li>
                                    <li><a target="_blank"
                                            href="auth-confirm-mail-2.html"
                                            key="t-confirm-mail-2">Confirm Email
                                            2</a></li>
                                    <li><a target="_blank"
                                            href="auth-email-verification.html"
                                            key="t-email-verification">Email
                                            verification</a></li>
                                    <li><a target="_blank"
                                            href="auth-email-verification-2.html"
                                            key="t-email-verification-2">Email
                                            Verification 2</a></li>
                                    <li><a target="_blank"
                                            href="auth-two-step-verification.html"
                                            key="t-two-step-verification">Two
                                            Step Verification</a></li>
                                    <li><a target="_blank"
                                            href="auth-two-step-verification-2.html"
                                            key="t-two-step-verification-2">Two
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="pages-starter.html"
                                            key="t-starter-page">Starter Page</a></li>
                                    <li><a target="_blank"
                                            href="pages-maintenance.html"
                                            key="t-maintenance">Maintenance</a></li>
                                    <li><a target="_blank"
                                            href="pages-comingsoon.html"
                                            key="t-coming-soon">Coming Soon</a></li>
                                    <li><a target="_blank" href="pages-404.html"
                                            key="t-error-404">Error 404</a></li>
                                    <li><a target="_blank" href="pages-500.html"
                                            key="t-error-500">Error 500</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="true">
                                    <li><a href="javascript: void(0);"
                                            key="t-level-1-1">Level 1.1</a></li>
                                    <li>
                                        <a href="javascript: void(0);"
                                            class="has-arrow" key="t-level-1-2">Level
                                            1.2</a>
                                        <ul class="sub-menu"
                                            aria-expanded="true">
                                            <li><a href="javascript: void(0);"
                                                    key="t-level-2-1">Level 2.1</a></li>
                                            <li><a href="javascript: void(0);"
                                                    key="t-level-2-2">Level 2.2</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
            ...
            <div data-simplebar class="h-100">
                ...
                <div class="p-4">
                    ...
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input theme-choice"
                    ...
                    <div class="form-check form-switch mb-5">
                        <input class="form-check-input theme-choice"
                            type="checkbox" id="rtl-mode-switch"
                    ...
                    <div class="form-check form-switch mb-5">
                        <input class="form-check-input theme-choice"
                            type="checkbox" id="dark-rtl-mode-switch">
